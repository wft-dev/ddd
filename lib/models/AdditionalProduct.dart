...
class AdditionalProduct extends amplify_core.Model {
  ...
  AdditionalProductModelIdentifier get modelIdentifier {
      return AdditionalProductModelIdentifier(
        id: id
      );
  }
  ...
  const AdditionalProduct._internal({required this.id, required productID, required name, required price, required quantity, type, createdAt, updatedAt, productItemsId}): _productID = productID, _name = name, _price = price, _quantity = quantity, _type = type, _createdAt = createdAt, _updatedAt = updatedAt, _productItemsId = productItemsId;
  
  factory AdditionalProduct({String? id, required String productID, required String name, required String price, required int quantity, String? type, String? productItemsId}) {
  ...
  AdditionalProduct copyWith({String? productID, String? name, String? price, int? quantity, String? type, String? productItemsId}) {
    return AdditionalProduct._internal(
      id: id,
  ...
  AdditionalProduct copyWithModelFieldValues({
    ...
    return AdditionalProduct._internal(
      ...
      productItemsId: productItemsId == null ? this.productItemsId : productItemsId.value
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'productID': _productID, 'name': _name, 'price': _price, 'quantity': _quantity, 'type': _type, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'productItemsId': _productItemsId
  };
  ...
  static final amplify_core.QueryModelIdentifier<AdditionalProductModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<AdditionalProductModelIdentifier>();
  ...
  static final PRODUCTITEMSID = amplify_core.QueryField(fieldName: "productItemsId");
...
class _AdditionalProductModelType extends amplify_core.ModelType<AdditionalProduct> {
 ...
 */
class AdditionalProductModelIdentifier implements amplify_core.ModelIdentifier<AdditionalProduct> {
  final String id;

  /** Create an instance of AdditionalProductModelIdentifier using [id] the primary key. */
  const AdditionalProductModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is AdditionalProductModelIdentifier &&
      id == other.id;
  }
