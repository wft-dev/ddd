  ...
  ListView buildMoreProductListView() {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          MoreProduct moreProductByIndex = moreProductList[index];
          return SizedBox(
            // height: 50,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                buildDropDown(index, moreProductList[index].type, (value) {
                  setState(() {
                    moreProductList[index] =
                        moreProductByIndex.copyWith(type: value);
                  });
                }),
                generateTextField(groupControllers[indexForList].name,
                  ...
                  setState(() {
                    moreProductList[index] =
                        moreProductByIndex.copyWith(name: value);
                  });
                }),
                generateTextField(groupControllers[indexForList].price,
                    Strings.price, TextInputAction.next, (value) {
                  setState(() {
                    moreProductList[index] = moreProductByIndex.copyWith(
                        price: value.parseInt(),
                        productMoreProductsId: '$indexForList');
                  });
                }),
                generateTextField(groupControllers[indexForList].quantity,
                  ...
                  setState(() {
                    moreProductList[index] =
                        moreProductByIndex.copyWith(quantity: value.parseInt());
                  });
                }),
                AppButton(
                  text: Strings.remove,
                  onPress: () {
                    ...
                    setState(() {
                      groupControllers.add(group);
                      moreProductList.removeAt(index);
                    });
                  },
                ),
              ],
