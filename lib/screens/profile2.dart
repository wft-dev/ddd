...
//         print('loading .....');
//         return Stack(
//             children: [CircularProgressIndicator(color: AppColors.pinkColor)]);
//       },
//       data: (data) async {
//         User user = data;
//         if (!isImageSelected) {
...
//   // Widget getBody() {
//   //   // final profileData = ref.watch(updateUserControllerProvider).isLoading;
...
//     // getProfileData();
//     print('profileData.isLoading  ${profileData.isLoading}');
